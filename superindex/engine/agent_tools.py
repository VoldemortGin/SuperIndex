...
def _make_tool_function(name: str, description: str, schema: dict,
    ...
    def proxy(*args: Any, **kwargs: Any) -> str:
        # The invoker lets only SuperIndexAPIError through, so a TypeError
...
LOCAL_CITATION_PROMPTS: dict[str, str] = {
    "markdown": """\
GROUNDING
- Answer only from the user's SuperIndex documents. Call get_page_content() and state only what was actually read there.

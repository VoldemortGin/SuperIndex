...
Refines a SuperIndex tree so that navigating it is never more expensive than
...
Usage:
    python3 -m superindex.engine.tree_optimize --pdf doc.pdf --structure tree.json --plan
    python3 -m superindex.engine.tree_optimize --pdf doc.pdf --structure tree.json --no-expand
    python3 -m superindex.engine.tree_optimize --pdf doc.pdf --structure tree.json --out out.json
"""
